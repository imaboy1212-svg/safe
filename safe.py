...
- 모바일 가독성을 위해 한 문단은 2~3문장을 넘기지 말고 자주 줄바꿈하세요.
...
- 각 h2 단락 아래에 어울리는 이미지를 넣을 수 있도록, 다음 형식으로 이미지 프롬프트를 삽입하세요.
  [이미지 프롬프트: (영문 설명)]
- 내용 이해를 돕기 위한 이미지는 2D 픽토그램(2D pictogram)을 활용한, 누구나 한눈에 알아보기 쉬운 인포그래픽(infographic) 스타일로 묘사하세요.
- 화려하거나 인위적인 AI 그래픽 느낌, 사실적인 사진(Realistic photo) 느낌은 배제하세요.
